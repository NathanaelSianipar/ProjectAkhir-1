    ...
    <div class="row mb-5">
        <div class="col-md-4 mb-4 mb-md-0 footer-section">
            <div class="mb-4">
                <div class="footer-logo-box">
                    <div class="logo-icon"><span>GBI</span></div>
                    <div>
            ...
            <div class="social-links">
                <a href="https://web.facebook.com/GBITAMBUNANN"><i class="bi bi-facebook"></i></a>
        ...
        <div class="col-md-4 footer-section">
            ...
            <div class="contact-item">
                ...
                <div><small style="color:#b0b9c6;line-height:1.6;">Jl. Pasar Tambunan Desa No.4<br>Lumban Pea, Kec. Balige<br>Toba, Sumatera Utara</small></div>
            </div>
            <div class="contact-item flex-center">
                <div class="contact-icon"><i class="bi bi-telephone"></i></div>
                <div><a href="tel:+6285370385542" class="text-white text-decoration-none">+62 853-7038-5542</a></div>
            </div>
            <div class="contact-item flex-center">
                <div class="contact-icon"><i class="bi bi-envelope"></i></div>
                <div><a href="mailto:gbitambunan01@gmail.com" class="text-white text-decoration-none">gbitambunan01@gmail.com</a></div>
            </div>
        </div>
    </div>
